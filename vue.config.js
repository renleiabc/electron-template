 ...
 * @LastEditors: abc
 * @LastEditTime: 2020-10-27 16:52:49
...
module.exports = {
  ...
  pluginOptions: {
    electronBuilder: {
      builderOptions: {
        appId: "com.electorn-template.app", //包名
        asar: true,
        productName: "electorn-template", //项目名 这也是生成的exe文件的前缀名
        afterPack: "./public/afterPack.js",
        copyright: "这是一个electorn-template项目", //版权  信息
        directories: {
        ...
        nsis: {
          ...
          shortcutName: "electorn-template" // 图标名称
        }
      }
    }
  }
